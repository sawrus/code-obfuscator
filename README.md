...
- `.github/workflows/release.yml`: по git-тегам `v*` запускает `make release-artifacts` и публикует бинарники Linux/Windows/macOS с уникальными именами (`code-obfuscator-<target>`).
